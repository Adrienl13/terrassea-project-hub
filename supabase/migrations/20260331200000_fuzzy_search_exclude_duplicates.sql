-- ============================================================================
-- Migration: Exclude duplicate products from fuzzy search results
-- Date: 2026-03-31
-- Purpose: Products marked as duplicates (duplicate_of IS NOT NULL) should
--          not appear in search results. Also applies to search_products_multilang.
-- ============================================================================
