    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-3 border border-border rounded-sm text-base font-body bg-background focus:outline-none focus:ring-1 focus:ring-foreground/20"
        />
      </div>
