...
export default function FinancingRequestModal({
  ...
  const inputClass = "w-full text-base font-body bg-background border border-border rounded-lg px-4 py-3 focus:outline-none focus:border-foreground transition-colors";
