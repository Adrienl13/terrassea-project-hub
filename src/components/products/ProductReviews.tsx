...
function ReviewForm({ productId, onSuccess }: { productId: string; onSuccess: () => void }) {
  ...
  const inputClass = "w-full text-base font-body bg-background border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-foreground transition-colors";
