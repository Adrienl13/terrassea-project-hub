...
const ProjectBriefModal = ({ open, onClose, product, offer }: ProjectBriefModalProps) => {
  ...
  const selectClass = "w-full text-base font-body bg-background border border-border rounded-full px-4 py-3 focus:outline-none focus:border-foreground transition-colors appearance-none cursor-pointer";
