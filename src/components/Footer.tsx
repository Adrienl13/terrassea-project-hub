    ...
    <footer className="bg-foreground text-primary-foreground py-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div>
            <h4 className="font-display font-semibold text-sm mb-4">{t('footer.legalTitle', 'Légal')}</h4>
            <div className="flex flex-col gap-3">
              <Link to="/mentions-legales" className="text-sm font-body opacity-60 hover:opacity-100 transition-opacity">{t('legal.mentions')}</Link>
              <Link to="/cgv" className="text-sm font-body opacity-60 hover:opacity-100 transition-opacity">{t('legal.cgv')}</Link>
              <Link to="/cgu" className="text-sm font-body opacity-60 hover:opacity-100 transition-opacity">{t('legal.cgu')}</Link>
              <Link to="/confidentialite" className="text-sm font-body opacity-60 hover:opacity-100 transition-opacity">{t('legal.privacy')}</Link>
            </div>
          </div>
        </div>
