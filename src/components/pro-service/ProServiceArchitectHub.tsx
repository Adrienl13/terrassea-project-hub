        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full text-base font-body bg-white border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground/50 resize-none"
            />
          </div>
...
function CreateCallView({
  ...
  const inputClass = "w-full text-base font-body bg-white border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground/50";
