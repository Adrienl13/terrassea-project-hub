      ...
      <div className="space-y-5">
        ...
        <Suspense fallback={<div className="h-40 animate-pulse bg-card rounded-xl" />}>
          <QuoteRecapCard quote={{
            ...
            tvaRate: (activeQuote as any).tvaRate ?? null,
            deliveryDelayDays: (activeQuote as any).deliveryDelayDays ?? null,
            deliveryConditions: (activeQuote as any).deliveryConditions ?? null,
            paymentConditions: (activeQuote as any).paymentConditions ?? null,
            validityDays: (activeQuote as any).validityDays ?? null,
            validityExpiresAt: (activeQuote as any).validityExpiresAt ?? null,
            partnerConditions: (activeQuote as any).partnerConditions ?? null,
