  ...
  return (
    <div className="mt-3 pt-3 border-t border-border space-y-2">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-[10px] font-body text-muted-foreground">Occupied surface</span>
          <span className="text-xs font-display font-medium text-foreground ml-auto">{metrics.estimatedOccupiedSurface} m²</span>
        </div>
        <div className="flex items-baseline gap-2">
          <span className="text-[10px] font-body text-muted-foreground">Remaining space</span>
