              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-3 text-base font-body bg-background border border-border rounded-lg outline-none focus:border-foreground capitalize"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="30"
                    className="w-full px-3 py-3 text-base font-body bg-background border border-border rounded-lg outline-none focus:border-foreground"
                  />
                </div>
