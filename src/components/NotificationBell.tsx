...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-background border border-border rounded-sm shadow-lg z-[60] overflow-hidden" role="region" aria-live="polite" aria-label={t("notifications.title")}>
          {/* Header */}
