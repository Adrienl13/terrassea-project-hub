...
export default function PartnerDetail() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-background">
        <Header />
        <div className="pt-12 md:pt-32 container mx-auto px-6">
  ...
  if (!partner) {
    return (
      <div className="min-h-screen bg-background">
        <Header />
        <div className="pt-12 md:pt-32 container mx-auto px-6 text-center">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ── HERO STRIP ── */}
      <section className="pt-12 md:pt-24 pb-8 px-6 border-b border-border" style={{ background: "#FAF7F4" }}>
