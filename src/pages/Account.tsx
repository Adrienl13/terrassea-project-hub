                    ...
                    {partnerPlan === "brand_member" || partnerPlan === "brand_network" ? (
                      <>
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 py-2.5 text-xs font-display font-semibold text-amber-700 border border-amber-300 bg-amber-50 rounded-full hover:bg-amber-100 transition-colors"
                        >
                          <Briefcase className="h-3.5 w-3.5" /> Pro Service
                        </button>
                      </>
                    ) : (
                      <button
