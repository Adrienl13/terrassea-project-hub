...
import {
  ...
  XCircle, AlertTriangle, Star, TrendingUp,
...
// Canonical lowercase-kebab slugs (cf. CLAUDE.md "Categories normalized
// 2026-04-30"). Imported from categoryNormalizer for single source of truth.
...
function ProductsTab() {
  ...
  const handleSave = async (data: ProductFormData) => {
    ...
    // Safety : normalize category to canonical lowercase-kebab in case legacy
    // CamelCase or AI-suggested values slip through (Dette 26).
