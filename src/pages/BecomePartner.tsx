...
const PLANS = [
  {
    ...
    name: "Starter",
    price: "Free",
    sub: "Until your 3rd confirmed order",
    commission: "8%",
    ...
    features: [
      ...
      { ok: true, label: "Partner profile page" },
      { ok: true, label: "Access to incoming quote requests" },
      { ok: false, label: "Priority in search results" },
  ...
  },
  {
    ...
    features: [
      { ok: true, label: "Unlimited products" },
      { ok: true, label: "5% commission (save vs 8%)" },
      { ok: true, label: "Verified Partner badge" },
      { ok: true, label: "Priority position in results" },
      { ok: true, label: "Analytics — views, quotes, orders" },
      { ok: true, label: "Leads 24h before standard partners" },
      { ok: true, label: "Stock sync via CSV" },
      { ok: true, label: "Everything in Starter" },
    ],
  ...
  },
  {
    ...
    name: "Elite",
    price: "Custom",
    sub: "Negotiated · for major brands",
    commission: "3%",
    ...
    features: [
      ...
      { ok: true, label: "Elite Partner badge" },
