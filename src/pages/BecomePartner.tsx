...
const BecomePartner = () => {
  ...
  const BRAND_PLANS = [
    {
      ...
      price: "799€ HT",
      sub: t('plans.brandMemberSub', '0% commission · direct sales to CHR buyers'),
      commission: "0%",
      ...
      features: [
        ...
        { ok: true, label: t('plans.features.commission2', '0% commission on confirmed orders') },
        { ok: true, label: t('plans.features.brandedPage') },
    ...
    },
    {
      ...
      price: "1299€ HT",
      sub: t('plans.brandNetworkSub', '0% commission · route via your distributors'),
      commission: "0%",
      badge: { label: t('plans.distributorNetwork', 'Distributor network'), bg: "#EDE9FE", color: "#6D28D9" },
      features: [
        { ok: true, label: t('plans.features.productsUnlimited', 'Unlimited products') },
        { ok: true, label: t('plans.features.commission15', '0% commission on confirmed orders') },
        { ok: true, label: t('plans.features.brandedPage') },
  ...
  if (phase === "submitted") {
    return (
      <div className="min-h-screen bg-background">
        <Header />
        <section className="pt-12 md:pt-32 pb-24 px-6">
          <motion.div
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-12 md:pt-32 pb-20 px-6 relative overflow-hidden">
        {/* Fond coloré */}
            ...
            {PLANS.map((plan) => (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full py-3 min-h-[44px] mt-3 font-display font-semibold text-xs rounded-full transition-all ${
                    plan.featured
            ...
            <div className="mt-8 space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full text-base font-body bg-card border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground/50 resize-none"
