...
const TERM_TO_CATEGORY_SLUG: Record<string, string> = {
  ...
  "vela ombreggiante": "parasols", pergola: "parasols",
  ...
  sofá: "lounge seating", sofa: "lounge seating", sofas: "lounge seating",
...
const TERM_TO_STYLE_SLUG: Record<string, string> = {
  ...
  // ES
  mediterráneo: "mediterranean", mediterraneo: "mediterranean",
  moderno: "modern", contemporáneo: "modern",
  natural: "natural", lujo: "luxury",
  costero: "coastal", escandinavo: "scandinavian",
  clásico: "classic", clasico: "classic",
  minimalista: "minimal", bohemio: "bohemian",
  rústico: "farmhouse", rustico: "farmhouse",
  // DE
  mediterran: "mediterranean", modern: "modern",
...
const TERM_TO_MATERIAL_SLUG: Record<string, string> = {
  ...
  vimini: "synthetic-rattan", rattan: "synthetic-rattan",
  ...
  glas: "glass", beton: "concrete", marmor: "marble-effect",
...
const TERM_TO_USE_CASE_SLUG: Record<string, string> = {
  ...
  "toit-terrasse": "rooftop", "rooftop": "rooftop",
  ...
  piscina: "pool-deck", playa: "beach-club",
  ...
  // DE
  "strandclub": "beach-club", "pool": "pool-deck",
